...
namespace Deveel.Math {
	public static class BigMath {
		...
		/// </remarks>
		/// <returns></returns>
		public static BigInteger ShiftRight(this BigInteger value, int n) {
		...
		/// </remarks>
		/// <returns></returns>
		public static BigInteger ShiftLeft(this BigInteger value, int n) {
		...
		/// </exception>
		public static BigInteger And(this BigInteger a, BigInteger b) {
			return Logical.And(a, b);
		}

		public static BigInteger Or(this BigInteger a, BigInteger b) {
			return Logical.Or(a, b);
		}

		public static BigInteger XOr(this BigInteger a, BigInteger b) {
		 ...
		 *             if {@code val == null}.
		 */
		public static BigInteger AndNot(this BigInteger value, BigInteger other) {
...
* @return {@code ~this}.
*/
		public static BigInteger Not(this BigInteger value) {
		...
		/// of this instance.
		/// </returns>
		public static BigInteger Negate(this BigInteger value) {
 ...
 *             if {@code divisor == 0}.
 */
		public static BigInteger Divide(this BigInteger dividend, BigInteger divisor) {
 ...
 */
		public static BigDecimal Divide(this BigDecimal a, BigDecimal b) {
 ...
 */
		public static BigDecimal Divide(this BigDecimal a, BigDecimal b, RoundingMode roundingMode) {
		...
		public static BigDecimal Divide(this BigDecimal a, BigDecimal b, int scale, RoundingMode roundingMode) {
 ...
 */
		...
		public static BigDecimal Divide(this BigDecimal a, BigDecimal b, MathContext context) {
 ...
 */
		...
		public static BigDecimal DivideToIntegral(this BigDecimal a, BigDecimal b) {
 ...
 */
		...
		public static BigDecimal DivideToIntegral(this BigDecimal a, BigDecimal b, MathContext context) {
 ...
 */
		...
		public static BigDecimal DivideAndRemainder(this BigDecimal a, BigDecimal b, out BigDecimal remainder) {
			return BigDecimalMath.DivideAndRemainder(a, b, out remainder);
		}

		public static BigDecimal[] DivideAndRemainderParts(this BigDecimal a, BigDecimal b)
		{
			BigDecimal[] result = new BigDecimal[2];

			result[0] = a.DivideToIntegral(b);
			result[1] = a.Subtract(result[0].Multiply(b));
 ...
 * @see #remainder
 */
		public static BigDecimal DivideAndRemainder(this BigDecimal a,
			BigDecimal b,
			MathContext context,
...
*             if {@code divisor == 0}.
*/
		public static BigDecimal Remainder(this BigDecimal a, BigDecimal b) {
 ...
 *             to be represented.
 */
		public static BigDecimal Remainder(this BigDecimal a, BigDecimal b, MathContext context) {
			BigDecimal remainder;
...
*/
		...
		public static BigDecimal Multiply(this BigDecimal value, BigDecimal multiplicand) {
 ...
 */
			...
			public static BigDecimal Multiply(this BigDecimal value, BigDecimal multiplicand, MathContext mc) {
...
*/
		public static BigDecimal Pow(this BigDecimal number, int exp) {
 ...
 *             if {@code n < 0} or {@code n > 999999999}.
 */
		public static BigDecimal Pow(this BigDecimal number, int exp, MathContext context) {
...
*/
		public static BigDecimal Abs(this BigDecimal number) {
		...
		public static BigDecimal Abs(this BigDecimal value, MathContext mc) {
		...
		public static BigDecimal Plus(this BigDecimal number) {
			return number;
		}
		...
		/// </returns>
		public static BigDecimal Plus(this BigDecimal number, MathContext mc) {
 ...
 */
		...
		public static BigDecimal Negate(this BigDecimal number) {
		...
		public static BigDecimal Negate(this BigDecimal number, MathContext mc) {
 ...
 *             precision.
 */
		public static BigDecimal Round(this BigDecimal number, MathContext mc) {
 ...
 */
		...
		public static BigDecimal ScaleByPowerOfTen(this BigDecimal number, int n) {
 ...
 *             if {@code divisor == 0}.
 */
		public static BigInteger Remainder(this BigInteger dividend, BigInteger divisor) {
 ...
 * @see #remainder
 */
		public static BigInteger DivideAndRemainder(this BigInteger dividend, BigInteger divisor, out BigInteger remainder) {
 ...
 *             if {@code m < 0}.
 */
		public static BigInteger Mod(this BigInteger value, BigInteger m) {
 ...
 *             to {@code m}
 */
		public static BigInteger ModInverse(this BigInteger value, BigInteger m) {
 ...
 */
		public static BigInteger ModPow(this BigInteger value, BigInteger exponent, BigInteger m) {
...
*/
		...
		public static BigDecimal Scale(this BigDecimal number, int newScale, RoundingMode roundingMode) {
			if (!Enum.IsDefined(typeof(RoundingMode), roundingMode))
				throw new ArgumentException();
 ...
 */
		public static BigDecimal Scale(this BigDecimal number, int newScale) {
...
*/
		...
		public static BigDecimal MovePointLeft(this BigDecimal number, int n) {
 ...
 */
		...
		public static BigDecimal MovePointRight(this BigDecimal number, int n) {
			return BigDecimalMath.MovePoint(number, number.Scale - (long) n);
		}
 ...
 */
		...
		public static BigDecimal Ulp(this BigDecimal value) {
		...
		/// </exception>
		public static BigDecimal Add(this BigDecimal value, BigDecimal augend, MathContext mc) {
		...
		/// </exception>
		public static BigDecimal Add(this BigDecimal value, BigDecimal augend) {
		...
		/// </exception>
		public static BigDecimal Subtract(this BigDecimal value, BigDecimal subtrahend) {
		...
		/// </exception>
		public static BigDecimal Subtract(this BigDecimal value, BigDecimal subtrahend, MathContext mc) {
 ...
 */
		...
		public static BigDecimal StripTrailingZeros(this BigDecimal value) {
			int i = 1; // 1 <= i <= 18
