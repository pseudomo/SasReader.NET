...
*/
    public class BinDecompressor : Decompressor
    {
        /**
         * Unambiguous class instance.
         */
        public static BinDecompressor INSTANCE = new BinDecompressor();
        ...
        public byte[] decompressRow(int pageoffset, int srcLength, int resultLength, byte[] page)
        {
            ...
            byte[] srcRow = page[pageoffset..(srcLength + pageoffset)];
            ...
            while (srcOffset < srcLength)
            {
                ...
                int cmd = (srcRow[srcOffset] >> 4) & 0x0F;
                ...
                switch (cmd)
                {
                    ...
                    case 2: // long pattern
                        ...
                        cnt += 16;
                        Array.Copy(outRow, outOffset - ofs, outRow, outOffset, cnt);
                        outOffset += cnt;
                        break;
                    ...
                    default: // short pattern
                        ofs = cnt + 3;
                        ofs += ((srcRow[srcOffset++] & 0xff) << 4);
                        Array.Copy(outRow, outOffset - ofs, outRow, outOffset, cmd);
                        outOffset += cmd;
                        break;
                }
            }
