...
namespace SasReader
{
     ...
     *
     */
    public class CharDecompressor : Decompressor
    {
        /**
         * Unambiguous class instance.
         */
        public static CharDecompressor INSTANCE = new CharDecompressor();
                ...
                switch (controlByte)
                {
                    ...
                    case 0x00:
                        if (currentByteIndex != length - 1)
                        {
                            ...
                            Array.Copy(page, offset + currentByteIndex + 2, resultByteArray,
                    ...
                    case 0xB0:
                        ...
                        Array.Copy(page, offset + currentByteIndex + 1, resultByteArray,
                                currentResultArrayIndex, countOfBytesToCopy);
